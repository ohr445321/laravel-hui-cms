    ...
    <form action="" method="post" class="form form-horizontal" id="form-user-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ $user->username }}" placeholder="" id="user-name" name="user_name">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="sex" type="radio" id="sex-1" value="男" @if($user->sex == '男') checked="checked" @endif>
                    <label for="sex-1">男</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="sex-2" value="女" name="sex" @if($user->sex == '女') checked="checked" @endif>
                    <label for="sex-2">女</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="sex-3" value="保密" name="sex" @if($user->sex == '保密') checked="checked" @endif>
