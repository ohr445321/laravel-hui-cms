...
<link rel="stylesheet" type="text/css" href="{{ asset('/static/admin/static/h-ui.admin/skin/blue/skin.css') }}" id="skin" />
<link rel="stylesheet" type="text/css" href="{{ asset('/static/admin/static/h-ui.admin/css/style.css') }}" />

<!-- 自定义css文件 -->
<link rel="stylesheet" type="text/css" href="{{ asset('/static/admin/public/css/common.css') }}" />
<!-- 自定义css文件 -->

<!--[if IE 6]>
<script type="text/javascript" src="{{ asset('/static/admin/lib/DD_belatedPNG_0.0.8a-min.js') }}" ></script>
